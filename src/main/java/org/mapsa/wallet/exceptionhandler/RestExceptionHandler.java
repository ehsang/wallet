package org.mapsa.wallet.exceptionhandler;

import org.mapsa.wallet.exceptionhandler.exceptions.ExceptionResponse;
import org.mapsa.wallet.exceptionhandler.exceptions.ServiceException;
...
public class RestExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> getException(MethodArgumentNotValidException exception){
        ...
        String message =
                "Error in the field: " + fieldError.getField() + " "
